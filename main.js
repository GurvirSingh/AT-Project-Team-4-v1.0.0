...
function addCode(paraID){
	alert("Adding code block of ID-"+paraID);
	var codetext = document.getElementById(paraID).innerHTML;
	
	document.getElementById("tb").innerHTML = codetext.replace("<br>","");
}
