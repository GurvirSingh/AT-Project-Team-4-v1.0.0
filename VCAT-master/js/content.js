...
chrome.runtime.onMessage.addListener(
    function(request, sender, sendResponse) {
        ...
        //Ambar code changes start
        console.log("content.js cmd value:"+cmd);
        debugger;  
        ...
        if (commandType.value == "select") {
            ...
            console.log("AMBAR backgroud.js page refreshed.");
            refreshPage();
        ...
        //Ambar code changes start
        else if(commandType.value=="download"){
           // alert("Download the code");
            performDownloadCode();
        }
        else if(commandType.value=="output"){
            debugger;
...
//Ambar code start for download the code
function performDownloadCode(){
    debugger;
    var code = document.getElementById("tb").value;
    console.log("Download code: "+code);
    downloadCode("download.js", code);
    
}

function performShowOutputCode(){
    var head= "<html><head><title>MyTitle</title></head>";
    var code = document.getElementById("tb").value;
    var body = "<body><script>"+code+"</script></body></html>";
    var opened = window.open("");
	opened.document.write(head+body);
}
