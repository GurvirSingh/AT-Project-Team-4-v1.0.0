        ...
        var commands = {
         ...
         /*   '(computer) click (on) (the) link *desc':function(desc){
            ...
            '(computer) open new tab':function(){
              console.log('calling from command..open new tab...AMBAR ');
            ...
            //Ambar code starts
            '(computer) download':function(){
                console.log('calling from command..download the code ');
                 var cmd = new Command();
                  cmd.addCommandWord('download','command');
                  performAction(cmd);
                   
            },
            '(computer) show output':function(){
                console.log('calling from command..showing the ouput of the code ');
                 var cmd = new Command();
                  cmd.addCommandWord('output','command');
                  performAction(cmd);
